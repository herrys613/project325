...
import { type Supplier, type SupplierForm, supplierFormSchema } from '../data/schema'
...
export function SuppliersMutateDrawer({ open, onOpenChange, currentRow }: Props) {
    ...
    >
      <SheetContent className='flex flex-col'>
        <SheetHeader className='text-start'>
          <SheetTitle>{isUpdate ? 'Update' : 'Add'} Supplier</SheetTitle>
          <SheetDescription>
            {isUpdate
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder='e.g. Global Parts Ltd.' />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
